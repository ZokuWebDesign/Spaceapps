...
**Contact API** (`server/`, deployed separately)

* Express
* Google Sheets API — service account, main + backup spreadsheets
* Mailgun — lead notification e-mails
* Render — hosting

The site is a **statically exported front-end**; all form handling lives in the standalone
Express service under [`server/`](server/). See [`PRODUCTION_DEPLOYMENT.md`](PRODUCTION_DEPLOYMENT.md)
for the architecture and [`GOOGLE_SHEETS_SETUP.md`](GOOGLE_SHEETS_SETUP.md) for the integration setup.
