    ...
    <>
      ...
      {isMobileMenuOpen && (
        <>
          ...
          {/* Menu */}
          <div ref={menuRef} className="fixed top-[88px] left-0 right-0 mx-4 bg-gradient-to-b from-[#363279] to-[#15153d] z-50 px-[6px] py-[12px] shadow-2xl rounded-2xl border border-white/10">
            <div className="flex flex-col">
              ...
              {/* Mobile Menu Content */}
              <div className="flex flex-col gap-2.5 mt-2 p-[19px] border-2 border-white/10 rounded-[9px] bg-white/5">
                ...
                <a href="#quem-faz-parte" className="mobile-nav-link">
                  Quem faz parte
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 18L15 12L9 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </a>
                <a href="#sobre-nos" className="mobile-nav-link">
                  Sobre nós
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 18L15 12L9 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </a>
                <a href="#planejamento" className="mobile-nav-link">
                  Planejamento
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 18L15 12L9 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </a>
                <a href="#checklist" className="mobile-nav-link">
                  Checklist
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 18L15 12L9 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </a>
                <a href="#depoimentos" className="mobile-nav-link">
                  Depoimentos
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 18L15 12L9 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </a>
                <a href="#tripulacao" className="mobile-nav-link">
                  Tripulação
                  <svg width="28" height="28" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M9 18L15 12L9 6" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
