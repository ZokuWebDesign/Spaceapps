  ...
  checklist: {
    ...
    phases: {
      phase1: {
        ...
        description: "Where it all begins: understand the context, assemble the crew and chart the route.\n\n1. Understand the problem →\n🧩 \"Identify the asteroid: what needs to be solved?\"\n\n2. Discover how to solve →\n🧭 \"Plan the mission route: what's the best path?\"\n\n3. Do research and discoveries →\n🔍 \"Explore the terrain: what already exists in the universe?\"\n\n4. Gather the team to define route →\n👩‍🚀 \"Assemble the crew and align the flight plan\""
      },
      phase2: {
        title: "Phase 2: Ship Design",
        subtitle: "Solution construction",
        description: "Time to sketch, draw and ensure the ship is ready to fly.\n\n1. Draw system screens →\n💻 Design the ship's control panel (UI/UX).\n\n2. Make technical understanding →\n🧰 Check if engines work: feasibility and architecture.\n\n3. Organize the schedule →\n🕓 Set up the mission timeline: each stage has its time."
      },
      phase3: {
        title: "Phase 3: Ground tests",
        subtitle: "Validation before takeoff",
        description: "Before pressing the red button, we need to ensure everything is safe and functional.\n\n1. Test in the real world →\n🌍 \"Simulate takeoff: test with real users.\n\n2. Document →\n📒 \"Record the logbook: ensure everyone knows how to navigate."
      },
      phase4: {
        title: "Phase 4: Launch",
        subtitle: "Development and monitoring",
        description: "Countdown initiated. Time to take flight!\n\n1. Start development →\n🕓 Fire up the main engines and take off!\n\n2. Hold regular meetings →\n📡 Check-ins with base: keep the mission under control.\n\n3. Deliver and start support →\n🛬 Land successfully and keep the system operational in space!"
      }
    }
  },
  contact: {
